...
public class TimerView extends View {
    ...
    private static final int initialArcSweepAngle = 270;
    private static final int initialArcStartAngle = 135;
    ...
    private void updateTimer(int timeMillisTotal, int timeMillisLeft) {
        if (isAnimationEnabled()) {
            ...
            setCurrentArcSweepAngleAndInvalidate(getNewSweepAngle(timeMillisTotal, timeMillisLeft));
